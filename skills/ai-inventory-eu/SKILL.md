...
| Manufacturing / production | predictive maintenance; visual quality control; shift scheduling / worker monitoring | machine-facing tools -> usually minimal; anything that allocates tasks to or monitors **people** -> check Annex III (worker management); emotion recognition at work -> **prohibited** (Art. 5) |
| Hospitality / gastronomy / local services | booking or ordering assistant; AI replies to reviews; demand forecasting | assistant -> Art. 50 **only if a model drives it**; AI-written review replies -> no label; forecasting -> usually minimal |
| Transport / logistics / construction | quote or booking chatbot; route optimization; fleet telematics; driver / site-worker monitoring | chatbot -> Art. 50 **only if a model drives it**; routing and telematics -> usually minimal; monitoring or scoring of drivers / workers -> check Annex III; emotion recognition at work -> **prohibited** (Art. 5) |
